...
declare function Toast({ title, onClick, text }: Props): react_jsx_runtime.JSX.Element;
...
declare const Tooltip: _stitches_react_types_styled_component.StyledComponent<"div", {}, {}, _stitches_react_types_css_util.CSS<{}, {
    colors: {
        white: string;
        black: string;
        gray100: string;
...
interface TooltipProps extends ComponentProps<typeof Tooltip> {
}
...
declare const theme: string & {
    ...
    colors: {
        ...
        redshift300: _stitches_react_types_theme.Token<"redshift300", string, "colors", "">;
        redshift500: _stitches_react_types_theme.Token<"redshift500", string, "colors", "">;
        redshift700: _stitches_react_types_theme.Token<"redshift700", string, "colors", "">;
        redshift900: _stitches_react_types_theme.Token<"redshift900", string, "colors", "">;
    };
    fontSizes: {
...
declare const createTheme: <Argument0 extends string | ({
    colors?: {
        ...
        redshift300?: string | number | boolean | undefined;
        redshift500?: string | number | boolean | undefined;
        redshift700?: string | number | boolean | undefined;
        redshift900?: string | number | boolean | undefined;
    } | undefined;
    fontSizes?: {
